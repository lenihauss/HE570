...
rel_path_meta = "UVP5_detailed/Export_metadata_summary.tsv" # relative path to data file
rel_path_particles = "UVP5_detailed/PAR_Aggregated.tsv" # relative path to data file
